...
def transaction():
    ...
    USD_TO_LBP = []
    LBP_TO_USD = []
    for tr in LIST_USD_TO_LBP:
        USD_TO_LBP.append((tr.usd_amount, tr.lbp_amount))
    for tr in LIST_LBP_TO_USD:
        LBP_TO_USD.append((tr.usd_amount, tr.lbp_amount))
    return jsonify(teller=transactions_schema.dump(user_teller_transactions), 
                   ...
                   usd_to_lbp=USD_TO_LBP, lbp_to_usd=LBP_TO_USD,
                   mapping=mapping)
